...
public class AppLifecycleBean {
	...
	private final boolean runFlywayOnStartup;
	...
	public AppLifecycleBean(
			AgroalDataSource ds,
			@ConfigProperty(name = "flyway.migrate-at-start", defaultValue = "false") boolean runFlywayOnStartup
	) {
		this.ds = requireNonNull(ds);
		this.runFlywayOnStartup = runFlywayOnStartup;
	}
