...
public class ImpfslotValidationJax {
	...
	@NonNull
	@Schema(format = OpenApiConst.Format.DATE, description = "Tag der ersten Impfung als Date-Type")
	...
	@NonNull
	@Schema(format = OpenApiConst.Format.DATE, description = "Tag der zweiten Impfung als Date-Type")
