...
public class TracingResource {
	...
	public TracingResponseJax findByRegistrierungsnummer (
		...
		return tracingService.findByRegistrierungsnummer(registrierungsnummer);
	}
	...
	public TracingResponseJax findByCertificatUVCI (
		...
		return tracingService.findByCertificatUVCI(uvci);
	}
	...
	public TracingResponseJax findByKrankenkassennummer (
		...
		return tracingService.findByKrankenkassennummer(krankenkassennummer);
	}
}
