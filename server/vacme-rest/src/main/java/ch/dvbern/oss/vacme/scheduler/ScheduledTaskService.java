...
public class ScheduledTaskService {
	...
	@Scheduled(cron = "{vacme.cron.callcenter.kennzahlen.mail}")
	void scheduleCallcenterKennzahlenMail() {
		systemAdminRunnerService.runCallcenterKennzahlenMailTask();
	}
	...
	@Scheduled(cron = "{vacme.cron.archivierung.pdf}")
