...
public class OrtDerImpfungDisplayNameJax extends AbstractUUIDEntityJax {
	...
	public OrtDerImpfungDisplayNameJax(@NonNull OrtDerImpfung ortDerImpfungEntity) {
		...
		this.noFreieTermine1 = ortDerImpfungEntity.isNoFreieTermine1();
		this.noFreieTermine2 = ortDerImpfungEntity.isNoFreieTermine2();
		this.noFreieTermineN = ortDerImpfungEntity.isNoFreieTermineN();
