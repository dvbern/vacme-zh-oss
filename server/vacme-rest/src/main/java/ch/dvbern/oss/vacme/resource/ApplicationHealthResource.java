...
public class ApplicationHealthResource {
	...
	@Path("inkonsistenzenStatus")
	@RolesAllowed(BenutzerRolleName.AS_REGISTRATION_OI)
	public List<RegistrierungTermineImpfungJax> getInkonsistenzenStatus() {
		return applicationHealthService.getInkonsistenzenStatus();
	}

	@GET
	@Produces(MediaType.APPLICATION_JSON)
	@Path("termineUnterschiedlicherOdi")
	@RolesAllowed(BenutzerRolleName.AS_REGISTRATION_OI)
	public List<RegistrierungTermineImpfungJax> getRegistrierungenMitUnterschiedlichenOdi() {
		return applicationHealthService.getRegistrierungenMitUnterschiedlichenOdi();
	}

	@GET
	@Produces(MediaType.APPLICATION_JSON)
	@Path("ausstehendeImpfungenZwei")
	@RolesAllowed(BenutzerRolleName.AS_REGISTRATION_OI)
	public List<RegistrierungTermineImpfungJax> getAusstehendeImpfungenZwei() {
		return applicationHealthService.getAusstehendeImpfungenZwei();
	}
