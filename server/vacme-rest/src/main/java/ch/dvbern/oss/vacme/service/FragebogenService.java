...
public class FragebogenService {
	...
	@NonNull
	public Fragebogen findFragebogenByRegistrierungsnummer(@NonNull String registrierungsnummer) {
	...
	@NonNull
	public Fragebogen findFragebogenByRegistrierungsnummerNoCheck(@NonNull String registrierungsnummer) {
