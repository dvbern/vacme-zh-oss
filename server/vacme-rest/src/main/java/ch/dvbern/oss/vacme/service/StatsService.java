...
public class StatsService {
	...
	private long getAnzahlImpfungNDurchgefueht() {
		return statsRepo.getAnzahlImpfungNDurchgefuehrt();
	}
	...
	public void takeKennzahlenSnapshot() {
		...
		long anzahlImpfungNDurchgefuehrt = this.getAnzahlImpfungNDurchgefueht();
		...
		this.statistikKennzahlEintragRepo.create(StatistikKennzahlEintrag.create(StatistikKennzahl.TOTAL_DURCHGEFUEHRTE_IMPFUNGN, anzahlImpfungNDurchgefuehrt));
	...
	public ImpfzentrumTagesReportJax getOdiTagesReport(@NonNull OrtDerImpfung ortDerImpfung, @NonNull LocalDate datum) {
		...
		List<Impfstoff> impfstoffList = statsRepo.getAllZugelassenenImpfstoffe();
		for (Impfstoff impfstoff : impfstoffList) {
			...
			jaxImpfstoff.setPendentTermin2(statsRepo.getPendentImpfung2ImpfstoffEmpfohlen(impfstoff, ortDerImpfung, datum));
			jaxImpfstoff.setPendentTerminN(statsRepo.getPendentImpfungNImpfstoffEmpfohlen(impfstoff, ortDerImpfung, datum));
		...
		jaxImpfstoffUnbekannt.setPendentTermin1(statsRepo.getPendentImpfung1(ortDerImpfung, datum));
		jaxImpfstoffUnbekannt.setPendentTermin2(statsRepo.getPendentImpfung2ImpfstoffUnbekannt(ortDerImpfung, datum));
		jaxImpfstoffUnbekannt.setPendentTerminN(statsRepo.getPendentImpfungNImpfstoffUnbekannt(ortDerImpfung, datum));
