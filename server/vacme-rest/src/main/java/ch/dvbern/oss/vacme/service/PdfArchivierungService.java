...
public class PdfArchivierungService {
	...
	public void archive(@NonNull ArchivierungDataRow dataRow) {
		try {
			final ImpfinformationDto infos =
				impfinformationenService.getImpfinformationenNoCheck(dataRow.getFragebogen().getRegistrierung().getRegistrierungsnummer());
			...
			List<RegistrierungFile> uploadedFiles = dokumentRepo.getRegistrierungFiles(
				dataRow.getFragebogen().getRegistrierung(),
	...
	public void archiveManually(@NonNull Registrierung registrierung) {
		...
		final ImpfinformationDto infos = impfinformationenService.getImpfinformationenNoCheck(registrierung.getRegistrierungsnummer());
