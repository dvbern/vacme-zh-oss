...
public class OrtDerImpfungResource {
	...
	public OrtDerImpfungJax erfassen(
		...
		OrtDerImpfung ortDerImpfung = ortDerImpfungService.createOrtDerImpfung(ortDerImpfungJax.getUpdateEntityConsumer(true, geocodeService));
		ortDerImpfungService.addImpfstoffeToOdi(ortDerImpfung, ortDerImpfungJax.getImpfstoffe());
