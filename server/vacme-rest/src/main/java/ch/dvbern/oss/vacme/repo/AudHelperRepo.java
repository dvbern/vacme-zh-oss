...
public class AudHelperRepo {
	...
	public void deleteFragebogenDataInAuditTables(@NonNull Fragebogen fragebogen) {
		final ImpfungkontrolleTermin kontrolle1 = fragebogen.getPersonenkontrolle().getKontrolleTermin1();
		if (kontrolle1 != null) {
			deleteImpfungkontrolleTerminAUD(kontrolle1);
		}
		final ImpfungkontrolleTermin kontrolle2 = fragebogen.getPersonenkontrolle().getKontrolleTermin2();
		if (kontrolle2 != null) {
			deleteImpfungkontrolleTerminAUD(kontrolle2);
		}
		deletePersonenkontrolleAUD(fragebogen.getPersonenkontrolle());
	...
	public void deleteExternesZertifikatInAuditTables(ExternesZertifikat externesZertifikat) {
