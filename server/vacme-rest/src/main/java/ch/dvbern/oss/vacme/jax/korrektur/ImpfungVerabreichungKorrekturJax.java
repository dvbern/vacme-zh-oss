...
@AllArgsConstructor
@ToString
public class ImpfungVerabreichungKorrekturJax {

	@NonNull
	private Impffolge impffolge;

	@NonNull
	private Verarbreichungsart verabreichungsart;

	@NonNull
	private Verarbreichungsort verabreichungsort;

	@NonNull
	private Verarbreichungsseite verabreichungsseite;
