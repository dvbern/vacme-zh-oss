...
@NoArgsConstructor
@AllArgsConstructor
public class RegistrierungsCodeJax {
	...
	@NonNull
	public static RegistrierungsCodeJax from(@NonNull Registrierung entity) {
		return new RegistrierungsCodeJax(
			entity.getPrioritaet(),
			entity.getRegistrierungsnummer(),
			entity.getRegistrierungStatus()
		);
	}
}
