...
public class RegistrierungTermineImpfungJax {
	...
	private @Nullable OrtDerImpfungDisplayNameJax gewuenschterOdi;
	...
	@SuppressWarnings("unused") // Wird in ApplicationHealthRepo benutzt (Projections.constructor)
	...
	private void readAttributesOfRegistration(@NonNull Registrierung registrierung) {
		...
		if (registrierung.getGewuenschterOdi() != null) {
			this.gewuenschterOdi = new OrtDerImpfungDisplayNameJax(registrierung.getGewuenschterOdi());
		}
	}
