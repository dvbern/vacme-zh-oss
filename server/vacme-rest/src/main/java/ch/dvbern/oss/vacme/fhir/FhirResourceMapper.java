...
public class FhirResourceMapper {
	...
	Immunization getImmunizationResource(Impfung impfung, Patient patient, PractitionerRole practitionerRole) {
	...
	Condition getConditionPregnancyResource(Date recordedTimestamp, Patient patient, PractitionerRole practitionerRole) {
	...
	Condition getConditionCovidIllnessResource( Registrierung registrierung, Patient patient) {
		Validate.notNull(registrierung.getPositivGetestetDatum(), "Positiv Getestet Datum is required");
		Validate.notNull(registrierung.getZweiteImpfungVerzichtetZeit(), "Zweite Impfung is required");

		return getConditionCovidIllnessResource(DateUtil.getDate(registrierung.getPositivGetestetDatum()),
			DateUtil.getDate(registrierung.getZweiteImpfungVerzichtetZeit()),patient);
	}
