...
public class OrtDerImpfungBuchungJax {
	...
	@NonNull
	public static OrtDerImpfungBuchungJax from(@NonNull OrtDerImpfung ortDerImpfung) {
		return new OrtDerImpfungBuchungJax(
			...
			ortDerImpfung.isNoFreieTermine1(),
			ortDerImpfung.isNoFreieTermine2(),
			ortDerImpfung.isNoFreieTermineN(),
