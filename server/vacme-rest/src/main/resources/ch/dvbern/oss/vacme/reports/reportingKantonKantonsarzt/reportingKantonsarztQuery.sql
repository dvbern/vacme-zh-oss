...
select
	...
	CASE WHEN Registrierung.vollstaendigerImpfschutz = 1 THEN 'TRUE' ELSE 'FALSE' END  as 'Vollstaendiger_Impfschutz',
    ...
    CASE WHEN Registrierung.genesen = 1 THEN 'TRUE' ELSE 'FALSE' END  as 'genesen',
	date_format(Registrierung.positivGetestetDatum, '%d.%m.%Y') as 'Datum_positiver_Test',
	CASE WHEN Registrierung.selbstzahler = 1 THEN 'TRUE' WHEN Registrierung.selbstzahler = 0 THEN 'FALSE' ELSE NULL END AS 'Selbstzahler'
