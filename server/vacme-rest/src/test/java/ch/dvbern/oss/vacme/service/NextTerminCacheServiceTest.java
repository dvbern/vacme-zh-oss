...
class NextTerminCacheServiceTest {
	...
	public void testNextFreiCallCache(){
		...
		Mockito.when(ortDerImpfungServiceMock.getNextFreierImpftermin(any(), eq(Impffolge.ERSTE_IMPFUNG), eq(null), eq(false)))
		...
		verify(ortDerImpfungServiceMock, times(1)).getNextFreierImpftermin(ortDerImpfungId, Impffolge.ERSTE_IMPFUNG, null, false);
		verify(ortDerImpfungServiceMock, times(1)).getNextFreierImpftermin(differentOdiId, Impffolge.ERSTE_IMPFUNG, null, false);
	}
	...
	public void testCacheDisabled(){
		...
		verify(ortDerImpfungServiceMock, times(5)).getNextFreierImpftermin(ortDerImpfungId, Impffolge.ERSTE_IMPFUNG, null, false);
		verify(ortDerImpfungServiceMock, times(5)).getNextFreierImpftermin(differentOdiId, Impffolge.ERSTE_IMPFUNG, null, false);
