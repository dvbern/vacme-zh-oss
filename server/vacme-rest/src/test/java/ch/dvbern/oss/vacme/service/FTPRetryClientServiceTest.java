...
class FTPRetryClientServiceTest {
	...
	public void testFtpFailure(){
		...
		DokumentRepo dokServiceMock = mock(DokumentRepo.class);
		...
		serviceUnderTest.tryToPutFilesToFtp("test.pdf", null,reg, content, RegistrierungFileTyp.TERMIN_BESTAETIGUNG_FTP_FAIL);
