...
class CheckRegistrierungVollstaendigerImpfschutzValidatorTest {
	...
	public void validationTest(
		...
		RegistrierungStatus registrierungStatus = RegistrierungStatus.valueOf(status);
		...
		registrierung.setVollstaendigerImpfschutzFlagAndTyp(approximateVollstaendigerImpfschutzTyp(vollstImpfschutzFlag, coronoa));
		registrierung.setZweiteImpfungVerzichtetGrund(verzichtGrund);
		registrierung.setGenesen(coronoa);
