...
public enum RegistrierungStatus {
	...
	@JsonIgnore
	@NonNull
	public static Set<RegistrierungStatus> getStatusWithPossibleZertifikat(){
	...
	@JsonIgnore
	@NonNull
	public static Set<RegistrierungStatus> getMindestensGrundimmunisiertOrAbgeschlossen(){
	...
	@JsonIgnore
	@NonNull
	public static Set<RegistrierungStatus> getAnyStatusOfGrundimmunisiert() {
		return Set.of(IMMUNISIERT, FREIGEGEBEN_BOOSTER, ODI_GEWAEHLT_BOOSTER, GEBUCHT_BOOSTER, KONTROLLIERT_BOOSTER);
	}

	@JsonIgnore
	@NonNull
	public static Set<RegistrierungStatus> isErsteImpfungDoneAndZweitePending() {
