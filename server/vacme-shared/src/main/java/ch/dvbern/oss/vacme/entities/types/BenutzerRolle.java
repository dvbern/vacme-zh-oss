...
public enum BenutzerRolle {
	...
	public static List<BenutzerRolle> getKantonRoles() {
		return Arrays.asList(KT_IMPFVERANTWORTUNG, KT_BENUTZER_REPORTER, KT_LOGISTIK_REPORTER, KT_MEDIZINISCHER_REPORTER, KT_BENUTZER_VERWALTER, KT_IMPFDOKUMENTATION);
	}
