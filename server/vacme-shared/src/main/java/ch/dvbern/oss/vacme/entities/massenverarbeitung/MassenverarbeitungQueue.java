...
public class MassenverarbeitungQueue extends AbstractEntity<Long>	{
	...
	@NonNull
	public static MassenverarbeitungQueue forImpfungOdiMove(@NonNull ID<Impfung> impfungId,
	...
	@NonNull
	public static MassenverarbeitungQueue forImpfungChangeVerantwortlicher(
		@NonNull ID<Impfung> impfungId,
		@NonNull ID<Benutzer> verantwortlicherId
	) {
		MassenverarbeitungQueue queue = new MassenverarbeitungQueue();
		queue.setTyp(MassenverarbeitungQueueTyp.IMPFUNG_VERANTWORTLICHER_CHANGE);
		queue.setStatus(MassenverarbeitungQueueStatus.NEW);
		queue.setErrorCount(0);

		queue.setImpfungId(impfungId.getId().toString());
		queue.setOdiId(verantwortlicherId.getId().toString());
		return queue;
	}
	...
	@NonNull
	public static MassenverarbeitungQueue forRegistrierungEnsureImpfdossier(@NonNull String registrierungNummer) {
		MassenverarbeitungQueue queue = new MassenverarbeitungQueue();
		queue.setTyp(MassenverarbeitungQueueTyp.ENSURE_IMPFDOSSIER_PRESENT);
		queue.setStatus(MassenverarbeitungQueueStatus.NEW);
		queue.setErrorCount(0);
		queue.setRegistrierungNummer(registrierungNummer);
		return queue;
