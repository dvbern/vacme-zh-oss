...
public final class MultipartFormToFileConverter {
	...
	@NonNull
	public static List<RegistrierungFile> parse(@NonNull MultipartFormDataInput input, @NonNull Registrierung registrierung,
		@NotNull @NonNull RegistrierungFileTyp fileTyp) {
		...
		return inputParts.stream()
			.map(inputPart -> toBlobData(inputPart, registrierung, fileTyp))
			.collect(Collectors.toList());
	}

	@NonNull
	private static RegistrierungFile toBlobData(@NonNull InputPart part, @NonNull Registrierung registrierung,
		@NotNull @NonNull RegistrierungFileTyp fileTyp) {
		try {
			...
			registrierungFile.setFileBlob(fileBlob);
