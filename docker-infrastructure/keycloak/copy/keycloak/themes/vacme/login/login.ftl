					...
					<form id="kc-form-login" onsubmit="login.disabled = true; return true;" action="${url.loginAction}" method="post">
						...
						<div class='inputfield'>
                            ...
                            <#if usernameEditDisabled??>
								<input tabindex="1" id="username" class="notice" name="username" value="${(login.username!'')}" type="text"
									   disabled/>
                            <#else>
								<input tabindex="1" id="username" class="notice" name="username" value="${(login.username!'')}" type="text"
						...
						<div class='inputfield'>
							<input tabindex="2" type="password" id="password" name="password" autocomplete="off"
						...
						<div class="${properties.kcFormGroupClass!} ${properties.kcFormSettingClass!}">
							...
							<div class="${properties.kcFormOptionsWrapperClass!}" style="margin-left: auto">
                                <#if realm.name == 'vacme' >
									<span><a tabindex="8" target="_blank"
						...
						<div id="kc-form-buttons" class="${properties.kcFormGroupClass!}">
							...
							<button tabindex="4" class='go-next' type="submit" name="login" id="kc-login">
    ...
    <#elseif section = "info" >
        <#if realm.password && realm.registrationAllowed && !registrationDisabled??>
			<div id="kc-registration">
				<span>${msg("noAccount")} <a tabindex="6" href="/impffaehigkeit">${msg("doRegister")}</a></span>
			</div>
        </#if>
    </#if>
