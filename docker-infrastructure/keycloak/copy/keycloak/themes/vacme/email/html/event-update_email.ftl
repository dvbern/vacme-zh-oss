                    ...
                    <tr>
                        <td align="center" style="padding:0;Margin:0">
                            <table class="es-content-body"
                                ...
                                <tr>
                                    <td align="left"
                                        style="padding:0;Margin:0;padding-top:20px;padding-right:20px;padding-bottom:30px">
                                            ...
                                            <tr>
                                                <td valign="top" align="center" style="padding:0;Margin:0;width:580px">
                                                    <table width="100%" cellspacing="0" cellpadding="0"
                                                           ...
                                                           style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                        <tr>
                                                            <td align="left" style="padding:20px;Margin:0;font-size:0px">
                                                                <img src="https://be.vacme.ch/img/Kanton-Bern.svg"
                                                                     alt
                                                        ...
                                                        <tr>
                                                            <td align="left" style="padding:0;Margin:0">
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                    ${kcSanitize(msg("emailAnrede"))?no_esc} ${kcSanitize(user.firstName)?no_esc} ${kcSanitize(user.lastName)?no_esc} (${kcSanitize(user.username)?no_esc})
                                                                </p>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left"
                                                                ...
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                    ${kcSanitize(msg("eventUpdateEmailBodyHtml", user.username, event.details[0].value))?no_esc}
                                                                </p>
                                                            </td>
                                                        </tr>
                                                    </table>
                                            ...
                                            <tr>
                                                <td valign="top" align="center" style="padding:0;Margin:0;width:600px">
                                                    <table width="100%" cellspacing="0" cellpadding="0"
                                                        ...
                                                        <tr>
                                                            <td align="left"
                                                                style="padding:0;Margin:0;padding-top:10px;padding-bottom:40px;padding-left:20px;">
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:17px;color:#333333;font-size:11px">
                                                                    © 2021 - COVID-19 Impfung des Kantons Bern<br></p>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
