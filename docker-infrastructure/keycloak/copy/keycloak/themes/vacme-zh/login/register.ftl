    ...
    <#elseif section = "form">
		<form id="kc-register-form" class="${properties.kcFormClass!}" action="${url.registrationAction}" method="post">
			...
			<div class='inputfield'>
				...
				<div>
					<span class="invisible errormessage"
						  id="telnummer_mobileNrWrongType">${msg("mobileNrWrongType")}</span>
				</div>
				<div>
					<span class="invisible errormessage"
						  id="telnummer_mobileNrWrongCountry">${msg("mobileNrWrongCountry")}</span>
				</div>
			</div>
            ...
            <#if passwordRequired>
				<div class='inputfield'>
					<input type="password"
						   ...
						   class='notice ${messagesPerField.printIfExists('password',properties.kcFormGroupErrorClass!)}'
				...
				<div class='inputfield'>
					...
					<span class="invisible errormessage"
						  id="password-match_error">${msg("notMatchPasswordMessage")}</span>
				</div>
