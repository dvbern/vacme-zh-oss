        ...
        <#if showMobilePhoneInput = true>
			<div class="govuk-grid-row">
				<div class="govuk-grid-column-full">
					...
					<p class="sms-instruction">${msg("updatePhoneNumberMessageAllowedCountries")}</p>
				</div>
					...
					<div class="form-group">
						<div class='inputfield govuk-grid-column-full ${errorClass!""}'>
							<input id="mobileNumberChangeConfirmCode"
								   ...
								   autocomplete="false"
								   autofocus>
							<label for="mobileNumberChangeConfirmCode"
								   class='floating-label floating-space-left'>${msg("sms-auth.code")}</label>
						</div>
					</div>
