...
export class KontrolleService {
     ...
     */
    public impfkontrolleResourceFind(registrierungsnummer: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<ImpfkontrolleJaxTS>;
    public impfkontrolleResourceFind(registrierungsnummer: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<ImpfkontrolleJaxTS>>;
    public impfkontrolleResourceFind(registrierungsnummer: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<ImpfkontrolleJaxTS>>;
    public impfkontrolleResourceFind(registrierungsnummer: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
    ...
    return this.httpClient.get<ImpfkontrolleJaxTS>(`${this.configuration.basePath}/api/v1/web/kontrolle/find/${encodeURIComponent(String(registrierungsnummer))}`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public impfkontrolleResourceWahrnehmenZweiteImpfung(registrierungsnummer: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext}): Observable<any>;
    public impfkontrolleResourceWahrnehmenZweiteImpfung(registrierungsnummer: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext}): Observable<HttpResponse<any>>;
    public impfkontrolleResourceWahrnehmenZweiteImpfung(registrierungsnummer: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext}): Observable<HttpEvent<any>>;
    public impfkontrolleResourceWahrnehmenZweiteImpfung(registrierungsnummer: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: undefined, context?: HttpContext}): Observable<any> {
        if (registrierungsnummer === null || registrierungsnummer === undefined) {
    ...
    return this.httpClient.post<any>(`${this.configuration.basePath}/api/v1/web/kontrolle/wahrnehmenZweiteImpfung/${encodeURIComponent(String(registrierungsnummer))}`,
        null,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
