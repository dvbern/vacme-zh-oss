...
export class ImpfslotService {
    ...
    /**
     * Gibt Liste der Impfslots eines ODI und Tages
     * @param ortDerImpfungId 
     * @param date 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public impfslotResourceGetImpfslotByODIDate(ortDerImpfungId: string, date?: object, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<Array<ImpfslotDisplayDayJaxTS>>;
    public impfslotResourceGetImpfslotByODIDate(ortDerImpfungId: string, date?: object, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<Array<ImpfslotDisplayDayJaxTS>>>;
    public impfslotResourceGetImpfslotByODIDate(ortDerImpfungId: string, date?: object, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<Array<ImpfslotDisplayDayJaxTS>>>;
    public impfslotResourceGetImpfslotByODIDate(ortDerImpfungId: string, date?: object, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (ortDerImpfungId === null || ortDerImpfungId === undefined) {
            throw new Error('Required parameter ortDerImpfungId was null or undefined when calling impfslotResourceGetImpfslotByODIDate.');
        }
    ...
    return this.httpClient.get<Array<ImpfslotDisplayDayJaxTS>>(`${this.configuration.basePath}/api/v1/web/impfslot/findByDate/${encodeURIComponent(String(ortDerImpfungId))}`,
            {
                context: localVarHttpContext,
                params: localVarQueryParameters,
                responseType: <any>responseType_,
