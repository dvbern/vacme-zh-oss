...
export class KorrekturService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public korrekturResourceGetDashboardRegistrierung(registrierungsnummer: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<KorrekturDashboardJaxTS>;
    public korrekturResourceGetDashboardRegistrierung(registrierungsnummer: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<KorrekturDashboardJaxTS>>;
    public korrekturResourceGetDashboardRegistrierung(registrierungsnummer: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<KorrekturDashboardJaxTS>>;
    public korrekturResourceGetDashboardRegistrierung(registrierungsnummer: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (registrierungsnummer === null || registrierungsnummer === undefined) {
            throw new Error('Required parameter registrierungsnummer was null or undefined when calling korrekturResourceGetDashboardRegistrierung.');
        }
    ...
    return this.httpClient.get<KorrekturDashboardJaxTS>(`${this.configuration.basePath}/api/v1/web/korrektur/dashboard/${encodeURIComponent(String(registrierungsnummer))}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
