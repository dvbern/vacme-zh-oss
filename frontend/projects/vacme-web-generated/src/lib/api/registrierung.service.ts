...
export class RegistrierungService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public registrierungResourceFind(registrierungsnummer: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<RegistrierungsCodeJaxTS>;
    public registrierungResourceFind(registrierungsnummer: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<RegistrierungsCodeJaxTS>>;
    public registrierungResourceFind(registrierungsnummer: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<RegistrierungsCodeJaxTS>>;
    public registrierungResourceFind(registrierungsnummer: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (registrierungsnummer === null || registrierungsnummer === undefined) {
            throw new Error('Required parameter registrierungsnummer was null or undefined when calling registrierungResourceFind.');
        }
    ...
    return this.httpClient.get<RegistrierungsCodeJaxTS>(`${this.configuration.basePath}/api/v1/reg/registration/find/${encodeURIComponent(String(registrierungsnummer))}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public registrierungResourceUpdateExternGeimpft(registrierungsnummer: string, rollback: boolean, externGeimpftJaxTS?: ExternGeimpftJaxTS, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<DashboardJaxTS>;
    public registrierungResourceUpdateExternGeimpft(registrierungsnummer: string, rollback: boolean, externGeimpftJaxTS?: ExternGeimpftJaxTS, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<DashboardJaxTS>>;
    public registrierungResourceUpdateExternGeimpft(registrierungsnummer: string, rollback: boolean, externGeimpftJaxTS?: ExternGeimpftJaxTS, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<DashboardJaxTS>>;
    public registrierungResourceUpdateExternGeimpft(registrierungsnummer: string, rollback: boolean, externGeimpftJaxTS?: ExternGeimpftJaxTS, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (registrierungsnummer === null || registrierungsnummer === undefined) {
    ...
    return this.httpClient.post<DashboardJaxTS>(`${this.configuration.basePath}/api/v1/reg/registration/externGeimpft/${encodeURIComponent(String(registrierungsnummer))}/${encodeURIComponent(String(rollback))}`,
        externGeimpftJaxTS,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
