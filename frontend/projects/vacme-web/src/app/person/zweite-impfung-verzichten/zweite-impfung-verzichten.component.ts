...
import {ImpffolgeTS, KontrolleService, ZweiteImpfungVerzichtenJaxTS} from 'vacme-web-generated';
...
export class ZweiteImpfungVerzichtenComponent implements OnInit, OnDestroy {
    ...
    public keineZweiteImpfungGroup!: FormGroup;
    public verzichtenBegruendungGroup!: FormGroup;
    ...
    verzichtenZweiteImpfung(): void {
        ...
        this.kontrolleService.impfkontrolleResourceVerzichtenZweiteImpfung(jax)
            .subscribe(
                value => this.router.navigate(['dossier', this.registrierungsnummer]),
