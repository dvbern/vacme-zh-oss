...
import {DownloadService, RegistrierungStatusTS} from 'vacme-web-generated';
...
export class PersonDocumentsComponent implements OnInit {
    ...
    downloadTerminConfirmation(): void {
        this.downloadService.downloadResourceDownloadTerminBestaetigung(this.registration)
            .subscribe(BlobUtil.openInNewTab, error => {
    ...
    downloadImpfdokumentation(): void {
        this.downloadService.downloadResourceDownloadImpfdokumentation(this.registration)
            .subscribe(BlobUtil.openInNewTab, error => {
