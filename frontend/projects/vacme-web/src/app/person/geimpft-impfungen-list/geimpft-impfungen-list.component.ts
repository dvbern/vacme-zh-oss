...
export class GeimpftImpfungenListComponent implements OnInit {
    ...
    private hasExternesZertifikat(): boolean {
    ...
    private createDisplayList(): void {
        ...
        else if (!this.dashboardJax.impfung1
        ...
        else if (!this.dashboardJax.impfung2
    ...
    public getTitle(impffolgeNr: number, impffolge?: ImpffolgeTS, impfung?: ImpfungJaxTS): string {
        if (impfung) {
            return this.translationService.instant('GEIMPFT.IMPFUNGSDATEN', {
    ...
    public needsZweitimpfung(): boolean {
        ...
        return ExternGeimpftUtil.needsZweitimpfung(this.dashboardJax.impfung1.impfstoff, this.dashboardJax?.externGeimpft);
    }
