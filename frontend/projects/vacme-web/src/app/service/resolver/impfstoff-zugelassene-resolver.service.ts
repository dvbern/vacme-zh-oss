...
/**
 * Holt die Liste der Impfstoffe, die zugelassen sind
 */
export class ImpfstoffZugelasseneResolverService implements Resolve<Array<ImpfstoffJaxTS>> {
    ...
    public resolve(route: ActivatedRouteSnapshot): Observable<Array<ImpfstoffJaxTS>> {
        return this.impfdokumentationService.impfdokumentationResourceGetZugelasseneImpfstoffeList();
    }
}
