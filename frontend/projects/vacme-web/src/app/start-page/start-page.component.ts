...
export class StartPageComponent extends BaseDestroyableComponent implements OnInit {
    ...
    public neuesOrtDerImpfung(): void {
        this.router.navigate(['/ortderimpfung/stammdaten']);
    }

    public ortderImpfungBearbeiten(id: string | undefined): void {
        this.router.navigate(['/ortderimpfung/stammdaten', id]);
    }
    ...
    public showMassenimport(): boolean{
        return TenantUtil.BERN && this.isAsRegistrationOiBenutzer();
    }
