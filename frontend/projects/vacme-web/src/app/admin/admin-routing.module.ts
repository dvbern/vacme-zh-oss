...
import {ImpfstoffZugelassenAndExternZugelassenResolverService} from '../service/resolver/impfstoff-zugelassen-and-extern-zugelassen-resolver.service';
...
const routes: Routes = [
    ...
    },
    {
        ...
        resolve: {
            impfstoffList: ImpfstoffZugelassenAndExternZugelassenResolverService
        }
    },
    {
