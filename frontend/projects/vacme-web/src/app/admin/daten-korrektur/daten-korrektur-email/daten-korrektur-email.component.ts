...
import {BenutzerBasicinfoJaxTS, DashboardJaxTS, DossierService, EmailTelephoneKorrekturJaxTS, KorrekturService} from 'vacme-web-generated';
import {LogFactory} from 'vacme-web-shared';
import {BenutzerService} from '../../../../../../vacme-web-generated/src/lib/api/benutzer.service';
import {DB_DEFAULT_MAX_LENGTH, EMAIL_PATTERN, TEL_REGEX_NUMBER_INT} from '../../../../../../vacme-web-shared/src/lib/constants';
...
export class DatenKorrekturEmailComponent implements OnInit, OnDestroy {
    ...
    @Input()
    set dashboardJax(value: DashboardJaxTS | undefined) {
        this.dashboard = value;
        if (this.hasRequiredRole() && this.dashboard?.registrierungsnummer) {
            this.dossierService.dossierResourceGetUsername(this.dashboard.registrierungsnummer)
                .subscribe(response => {
    ...
    private correctData(): void {
        ...
        const regNummer = this.dashboard?.registrierungsnummer;
        if (!regNummer) {
            return;
        }
