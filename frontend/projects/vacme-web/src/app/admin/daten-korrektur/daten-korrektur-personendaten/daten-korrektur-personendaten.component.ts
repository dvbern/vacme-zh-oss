...
export class DatenKorrekturPersonendatenComponent implements OnInit, OnChanges {
    ...
    ngOnChanges(changes: SimpleChanges): void {
        if (this.dashboardJax && this.dashboardJax.registrierungsnummer) {
            this.korrekturService.korrekturResourceGetPersonendaten(
                this.dashboardJax?.registrierungsnummer).pipe().subscribe(
    ...
    private formToModel(): PersonendatenKorrekturJaxTS {
        const model: PersonendatenKorrekturJaxTS = {
            registrierungsnummer: this.dashboardJax?.registrierungsnummer,
    ...
    private correctData(): void {
        ...
        this.korrekturService.korrekturResourcePersonendatenKorrigieren(regNummer, data).subscribe(res => {
            Swal.fire({
                icon: 'success',
