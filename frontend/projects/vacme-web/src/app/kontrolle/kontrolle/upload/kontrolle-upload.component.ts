...
import {DossierService, FileInfoJaxTS} from 'vacme-web-generated';
...
export class KontrolleUploadComponent implements OnInit {
    ...
    private doUpload$(files: File[], fileSysFiles: FileSystemFileEntry[]): Observable<FileInfoJaxTS[]> {
        ...
        if (files && files.length !== 0) {
            ...
            return this.blobService.postFiles$(files, this.regNummer).pipe(
                map(result => {
                    return result;
                })
            );
