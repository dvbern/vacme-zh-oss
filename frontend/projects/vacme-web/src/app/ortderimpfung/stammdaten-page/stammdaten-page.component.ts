...
export class StammdatenPageComponent extends BaseDestroyableComponent implements OnInit {
    ...
    public formGroupAdresse!: FormGroup;

    public typOptions = Object.values(OrtDerImpfungTypTS).map(t => {
            ...
            if (this.ortDerImpfung) {
                ...
                if (this.ortDerImpfung.impfstoffe) {
                    this.formGroup.get('impfstoffe')?.setValue(
                        this.ortDerImpfung.impfstoffe.map(impfstoff => impfstoff.id));
                }
            }
    ...
    private save(): void {
        const value: OrtDerImpfungJaxTS = Object.assign({},
            /**
            ...
            {fachverantwortungbab: this.formGroup.value.fachverantwortungbab.value},
            {
                organisationsverantwortung: !!this.formGroup.value.organisationsverantwortung ?
                    this.formGroup.value.organisationsverantwortung.value : undefined,
            });
    ...
    hasRoleBenutzerverwalter(): boolean {
        return this.authService.hasRole(TSRole.OI_BENUTZER_VERWALTER) || this.authService.hasRole(TSRole.AS_BENUTZER_VERWALTER);
    }
