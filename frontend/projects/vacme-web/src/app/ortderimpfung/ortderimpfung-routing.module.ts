...
import {ImpfslotParamsResolverService} from '../service/resolver/impfslot-params-resolver.service';
import {ImpfstoffZugelasseneResolverService} from '../service/resolver/impfstoff-zugelassene-resolver.service';
import {OidbenutzerResolverService} from '../service/resolver/oidbenutzer-resolver.service';
import {OrtDerImpfungResolverService} from '../service/resolver/ortderimpfung-resolver.service';
...
const routes: Routes = [
    ...
    },
    {
        ...
        resolve: {
            ortDerImpfung: OrtDerImpfungResolverService,
            impfstoffList: ImpfstoffZugelasseneResolverService
        },
    },
    {
    ...
    },
    {
        ...
        runGuardsAndResolvers: 'paramsOrQueryParamsChange',
        resolve: {
            user: OidbenutzerResolverService,
        },
    },
    {
        ...
        runGuardsAndResolvers: 'paramsOrQueryParamsChange',
        resolve: {
            data: ImpfslotParamsResolverService,
        },
    },
    {
        path: '',
