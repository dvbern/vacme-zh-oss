...
export class MassenverarbeitungPageComponent extends BaseDestroyableComponent implements OnInit {
    ...
    private initForm(): void {
        this.formGroup = this.fb.group({
            ...
            changeVerantwortlicher: this.fb.control(''),
    ...
    public submitChangeVerantwortlicher(): void {
        this.developService.developerResourceChangeVerantwortlicher(this.formGroup.get('changeVerantwortlicher')?.value)
            .subscribe(size => {
                LOG.info('Changed Verantwortlicher for {} Impfungen', size);
                this.showSuccessPopup();
                this.formGroup.get('changeVerantwortlicher')?.setValue('');
            }, error => LOG.error(error));
    }
    ...
    public impfungenLoeschen(): void {
        this.developService.developerResourceImpfungenLoeschen(this.formGroup.get('impfungenLoeschen')?.value)
            .subscribe(size => {
                LOG.info('Deleted {} Impfungen', size);
                this.showSuccessPopup();
