...
import {ImpfdokumentationCacheService} from '../../../../../../vacme-web/src/app/service/impfdokumentation.cache.service';
...
import {
    isAtLeastGebucht, isAtLeastGebuchtOrOdiGewaehlt,
...
export class TermineBearbeitenComponent implements OnInit, OnChanges {
    ...
    public selectOrtDerImpfung(): void {
        ...
        this.impfdokumentationCacheService.cacheSelectedOdi(this.selectedOdiId);
    }
