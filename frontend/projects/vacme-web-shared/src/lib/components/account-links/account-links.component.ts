...
import {DashboardJaxTS, DossierService, RegistrierungsCodeJaxTS, RegistrierungService} from 'vacme-web-generated';
...
export class AccountLinksComponent implements OnInit {
    ...
    private loadDashboardJax$(regCode: RegistrierungsCodeJaxTS): Observable<DashboardJaxTS> | Observable<undefined> {
        if (regCode?.registrierungsnummer) {
            return this.dossierService.dossierResourceRegGetDashboardRegistrierung(regCode.registrierungsnummer);
        }
        return of(undefined);
    }
