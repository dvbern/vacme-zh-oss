...
import {DashboardJaxTS, ImpfdossierJaxTS, ImpffolgeTS, ImpfungJaxTS} from 'vacme-web-generated';

export class BoosterUtil {

    public static hasVacmeImpfung(dashboardJaxTS: DashboardJaxTS): boolean {
