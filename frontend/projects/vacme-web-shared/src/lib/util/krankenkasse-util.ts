...
export class KrankenkasseUtil {
    ...
    public static krankenkasseOptions = Object.values(KrankenkasseTS).map(t => {
        return {label: t, value: t};
    });

    public static auslandArtOptions = Object.values(AuslandArtTS).map(t => {
        return {label: t, value: t};
    });

    public static createAuslandArtValidator(component: { formGroup: FormGroup }, krankenkasseKey: string): ValidatorFn {
        return (control: AbstractControl) => {
            ...
            if (![AuslandArtTS.AUSLANDSCHWEIZER, AuslandArtTS.GRENZGAENGER].includes(control.value)) {
    ...
    public static isKrankenkasseAusland(component: { formGroup: FormGroup }, krankenkasseKey: string): boolean {
    ...
    public static onKrankenkasseChange(component: {
        ...
        if (!!component.formGroup.get(krankenkasseKey)?.value && !this.isKrankenkasseAusland(component, krankenkasseKey)) {
            component.formGroup.get(auslandArtKey)?.setValue(undefined);
        }
    ...
    public static isKrankenkasseSelected(component: { formGroup: FormGroup; krankenkassenSelected: boolean },
