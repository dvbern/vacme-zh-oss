...
import {certifiableNamestringValidator} from '../../../../vacme-web-shared/src/lib/util/customvalidator/certifiable-namestring-validator';
...
export class PersonendatenPageComponent extends BaseDestroyableComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        ...
        this.formGroup = this.fb.group({
            ...
            schutzstatus: this.fb.control(false),
    ...
    private save(): void {
        ...
        this.registrierungsService.registrierungResourceRegistrieren(value).subscribe(
            (res: RegistrierungsCodeJaxTS) => {
                ...
                this.forwardToExternGeimpft(res);
            },
            (err: any) => {
    ...
    private forwardToExternGeimpft(code: RegistrierungsCodeJaxTS): void {
        this.router.navigate(['/externgeimpft/', code.registrierungsnummer]);
    }
    ...
    private formToModel(): CreateRegistrierungJaxTS {
        const model: CreateRegistrierungJaxTS = {
            ...
            schutzstatus: this.getFormControlValue('schutzstatus')
        };
