...
import {OnboardingService, RegistrierungsCodeJaxTS, RegistrierungService} from 'vacme-web-generated';
import {LogFactory} from 'vacme-web-shared';
// eslint-disable-next-line max-len
import {BaseDestroyableComponent} from '../../../../vacme-web-shared/src/lib/components/base-destroyable/base-destroyable.component'; // nur das JS importieren
...
export class OnboardingProcessPageComponent extends BaseDestroyableComponent implements OnInit {
    ...
    public finishOnboarding(): void {
        ...
        this.onboardingService.onboardingResourceFinishOnboardingAfterKeycloakRegistration().subscribe(
            (res: string) => {
                this.saveRequestPending = false;
                const message = '<p>' + this.translateService.instant('ONBOARDING.SUCCESS.MESSAGE_1') + '</p>'
                    + '<p>' + this.translateService.instant('ONBOARDING.SUCCESS.MESSAGE_2') + '</p>';
