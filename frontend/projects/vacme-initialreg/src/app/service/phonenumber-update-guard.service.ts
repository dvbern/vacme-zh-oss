...
import {isMobileNumer} from '../../../../vacme-web-shared/src/lib/util/customvalidator/phone-number-validator';
        ...
        return this.dossierService.dossierResourceRegGetDashboardRegistrierung(registrierungsnummer)
            .pipe(map(dashboard => {
                ...
                if (dashboard.timestampPhonenumberUpdate === undefined || dashboard.timestampPhonenumberUpdate === null ||
                    ...
                    if (telefonnummer && !isMobileNumer(telefonnummer)) {
